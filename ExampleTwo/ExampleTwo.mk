...
##
## Debug
ProjectName            :=ExampleTwo
ConfigurationName      :=Debug
WorkspacePath          :=/home/gustavotakeda/Documents/C++/SFMLExamples
ProjectPath            :=/home/gustavotakeda/Documents/C++/SFMLExamples/ExampleTwo
IntermediateDirectory  :=../bin-int/Debug-linux-x86_64/ExampleTwo
...
SourceSwitch           :=-c 
OutputFile             :=../bin/Debug-linux-x86_64/ExampleTwo/ExampleTwo
Preprocessors          :=$(PreprocessorSwitch)FLAC__NO_DLL $(PreprocessorSwitch)AL_LIBTYPE_STATIC $(PreprocessorSwitch)STB_TEXTEDIT_KEYTYPE=unsigned $(PreprocessorSwitch)SFML_STATIC $(PreprocessorSwitch)TWO_DEBUG 
ObjectSwitch           :=-o 
ArchiveOutputSwitch    := 
PreprocessOnlySwitch   :=-E
ObjectsFileList        :="ExampleTwo.txt"
PCHCompileFlags        :=
...
MakeIntermediateDirs:
	@test -d ../bin-int/Debug-linux-x86_64/ExampleTwo || $(MakeDirCommand) ../bin-int/Debug-linux-x86_64/ExampleTwo
...
$(IntermediateDirectory)/src_main.cpp$(ObjectSuffix): src/main.cpp
	...
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/gustavotakeda/Documents/C++/SFMLExamples/ExampleTwo/src/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/src_main.cpp$(ObjectSuffix) $(IncludePath)
...
##
clean:
	$(RM) -r ../bin-int/Debug-linux-x86_64/ExampleTwo/
